...
export default async function PerformancePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-anthracite-900 dark:text-stone-100">Performance</h1>
        <p className="text-sm text-stone-500 dark:text-stone-400">Vue d&apos;ensemble de l&apos;activite et des conversions.</p>
      </div>
