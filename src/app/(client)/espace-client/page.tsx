...
export default async function ClientHomePage() {
  ...
  const [publishedPropertyCount, searchRequests] = await Promise.all([
  ...
  const totalMatches = searchRequests.reduce(
    (sum, sr) => sum + sr._count.matches,
    0
  );
        ...
        <Link href="/espace-client/recherche">
          <Card hover className="h-full">
            <CardContent className="flex items-center gap-4 py-5">
              ...
              <div>
                <p className="text-sm font-semibold text-anthracite-800 dark:text-stone-200">Creer une demande</p>
                <p className="text-xs text-stone-500 dark:text-stone-400">Definir vos criteres de recherche</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card hover className="h-full">
            <CardContent className="flex items-center gap-4 py-5">
              ...
              <div>
                ...
                <p className="text-xs text-stone-500 dark:text-stone-400">Correspondances avec vos criteres</p>
              </div>
            </CardContent>
          </Card>
        </Link>
        ...
        <CardContent className="p-0">
          {recentMatches.length === 0 ? (
            <p className="px-6 py-8 text-center text-sm text-stone-400 dark:text-stone-500">
              Aucun match pour le moment. Creez une demande de recherche pour recevoir des correspondances.
            </p>
          ) : (
