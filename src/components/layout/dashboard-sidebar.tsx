...
export function DashboardSidebar({ badges = {} }: SidebarProps) {
  ...
  // Choose the most specific matching nav href so a child route doesn't also
  // light up its parent (e.g. /dashboard/contacts/dormants must not highlight
  // both "Contacts" and "Dormants").
